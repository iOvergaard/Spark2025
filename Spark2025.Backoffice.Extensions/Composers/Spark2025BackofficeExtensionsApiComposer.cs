...
namespace Spark2025.Backoffice.Extensions.Composers
{
    public class Spark2025BackofficeExtensionsApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Spark 2025Backoffice Extensions Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<Spark2025BackofficeExtensionsOperationSecurityFilter>();
            });
        }

        public class
            Spark2025BackofficeExtensionsOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
                ...
                ControllerActionDescriptor controllerActionDescriptor)
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith(
                    "Spark2025.Backoffice.Extensions.Controllers",
